...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_VENUSAUR_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Venusaur"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_VENUSAUR_MEGA : CRY_VENUSAUR,
        .natDexNum = NATIONAL_DEX_VENUSAUR,
        .categoryName = _("Seed"),
        .height = 24,
        .weight = 1555,
    ...
    [SPECIES_CHARIZARD_MEGA_X] =
    {
        ...
        .speciesName = _("Charizard"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_CHARIZARD_MEGA_X : CRY_CHARIZARD,
        .natDexNum = NATIONAL_DEX_CHARIZARD,
        .categoryName = _("Flame"),
        .height = 17,
        .weight = 1105,
    ...
    [SPECIES_CHARIZARD_MEGA_Y] =
    {
        ...
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Charizard"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_CHARIZARD_MEGA_Y : CRY_CHARIZARD,
        .natDexNum = NATIONAL_DEX_CHARIZARD,
        .categoryName = _("Flame"),
        .height = 17,
        .weight = 1005,
    ...
    [SPECIES_BLASTOISE_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Blastoise"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_BLASTOISE_MEGA : CRY_BLASTOISE,
        .natDexNum = NATIONAL_DEX_BLASTOISE,
        .categoryName = _("Shellfish"),
        .height = 16,
        .weight = 1011,
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Beedrill"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_BEEDRILL_MEGA : CRY_BEEDRILL,
        .natDexNum = NATIONAL_DEX_BEEDRILL,
        .categoryName = _("Poison Bee"),
        .height = 14,
        .weight = 405,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIDGEOT_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pidgeot"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_PIDGEOT_MEGA : CRY_PIDGEOT,
        .natDexNum = NATIONAL_DEX_PIDGEOT,
        .categoryName = _("Bird"),
        .height = 22,
        .weight = 505,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_ALAKAZAM_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Alakazam"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_ALAKAZAM_MEGA : CRY_ALAKAZAM,
        .natDexNum = NATIONAL_DEX_ALAKAZAM,
        .categoryName = _("Psi"),
        .height = 12,
        .weight = 480,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_GENGAR_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Gengar"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_GENGAR_MEGA : CRY_GENGAR,
        .natDexNum = NATIONAL_DEX_GENGAR,
        .categoryName = _("Shadow"),
        .height = 14,
        .weight = 405,
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Steelix"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_STEELIX_MEGA : CRY_STEELIX,
        .natDexNum = NATIONAL_DEX_STEELIX,
        .categoryName = _("Iron Snake"),
        .height = 105,
        .weight = 7400,
    ...
    [SPECIES_KANGASKHAN_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Kangaskhan"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_KANGASKHAN_MEGA : CRY_KANGASKHAN,
        .natDexNum = NATIONAL_DEX_KANGASKHAN,
        .categoryName = _("Parent"),
        .height = 22,
        .weight = 1000,
    ...
    [SPECIES_SCIZOR_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Scizor"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_SCIZOR_MEGA : CRY_SCIZOR,
        .natDexNum = NATIONAL_DEX_SCIZOR,
        .categoryName = _("Pincer"),
        .height = 20,
        .weight = 1250,
    ...
    [SPECIES_PINSIR_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pinsir"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_PINSIR_MEGA : CRY_PINSIR,
        .natDexNum = NATIONAL_DEX_PINSIR,
        .categoryName = _("Stag Beetle"),
        .height = 17,
        .weight = 590,
    ...
    [SPECIES_GYARADOS_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gyarados"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_GYARADOS_MEGA : CRY_GYARADOS,
        .natDexNum = NATIONAL_DEX_GYARADOS,
        .categoryName = _("Atrocious"),
        .height = 65,
        .weight = 3050,
    ...
    [SPECIES_AERODACTYL_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Aerodactyl"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_AERODACTYL_MEGA : CRY_AERODACTYL,
        .natDexNum = NATIONAL_DEX_AERODACTYL,
        .categoryName = _("Fossil"),
        .height = 21,
        .weight = 790,
    ...
    [SPECIES_MEWTWO_MEGA_X] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Mewtwo"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_MEWTWO_MEGA_X : CRY_MEWTWO,
        .natDexNum = NATIONAL_DEX_MEWTWO,
        .categoryName = _("Genetic"),
        .height = 23,
        .weight = 1270,
    ...
    [SPECIES_MEWTWO_MEGA_Y] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Mewtwo"),
        .cryId = P_MODIFIED_MEGA_CRIES ? CRY_MEWTWO_MEGA_Y : CRY_MEWTWO,
        .natDexNum = NATIONAL_DEX_MEWTWO,
        .categoryName = _("Genetic"),
        .height = 15,
        .weight = 330,
