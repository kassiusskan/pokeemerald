...
static u32 LoopedTask_CannotAccessPC(s32); //PC
...
static void PrintCannotAccessPC(void); //PC
...
static const LoopedTask sMenuHandlerLoopTaskFuncs[] =
{
    ...
    [POKENAV_MENU_FUNC_OPEN_FEATURE]          = LoopedTask_OpenPokenavFeature, //pc
    [POKENAV_MENU_FUNC_CANNOT_ACCESS_PC]      = LoopedTask_CannotAccessPC //pc
};
