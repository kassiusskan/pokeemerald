...
#define SHOULD_RECOVER_CHANCE                                   70 // Chance the AI will give recovery moves score increase if less than ENABLE_RECOVERY_THRESHOLD and in no immediate danger
...
#define PREDICT_SWITCH_CHANCE                                   80
