...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            FALSE //DISABLED_ON_RELEASE // Enables an overworld debug menu to change flags, variables, giving pokemon and more, accessed by holding R and pressing START while in the overworld by default.
